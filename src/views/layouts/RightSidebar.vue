<template>
  ...
  >
    ...
    >
        ...
        <div class="flex-1">
          ...
          <div>
            ...
            >
              ...
              <option
                value="double-top"
                data-page-url="../modules/components/navs-and-tabs/double-top-navbar.html"
              >
                Double Top
              </option>
            </select>
      ...
      <div class="text-center mt-5">
        ...
        <p class="fs--1">
          Get Intellect now and create beautiful dashboards with hundreds of
          widgets.
        </p>
        <a
  ...
  >
    <div class="card-body d-flex align-items-center py-md-2 px-2 py-1">
      ...
      <small
        class="text-uppercase text-primary fw-bold bg-soft-primary py-2 pe-2 ps-1 rounded-end"
        >customize</small
      >
    </div>
  </a>
